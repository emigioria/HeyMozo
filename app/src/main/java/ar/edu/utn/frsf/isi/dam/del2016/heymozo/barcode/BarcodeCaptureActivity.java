 ...
 */
package ar.edu.utn.frsf.isi.dam.del2016.heymozo.barcode;
...
public final class BarcodeCaptureActivity extends AppCompatActivity
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(this, "Poco espacio",
                        Toast.LENGTH_LONG).show();
                Log.w(TAG, "Poco espacio");
            }
        }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        builder.setTitle("Multitracker sample")
                .setMessage("Esta aplicación no puede funcionar correctamente si no tiene los permisos para utilizar su cámara.")
